...
-- 12. 
SELECT EMP_NAME, BASIC + (0.5 * BASIC) + (0.4 * BASIC) AS NET_PAY FROM EMPLOYEE;
...
-- 15.
SELECT COUNT(*) AS JAN_JOINED FROM EMPLOYEE WHERE MONTH(JN_DT) = 1;

-- 16.
SELECT MAX(BASIC) AS MAX_BASIC, MIN(BASIC) AS MIN_BASIC FROM EMPLOYEE;

-- 17.
SELECT COUNT(*) AS FEMALE_EMPLOYEES FROM EMPLOYEE WHERE SEX = 'F';
